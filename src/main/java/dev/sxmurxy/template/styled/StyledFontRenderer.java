		...
		for(int i = 0; i < text.length(); i++) {
			...
			if (c0 == 167 && i + 1 < text.length() &&
				...
				if(strikethrough) {
					...
					BUILDER.vertex(matrix, posX, posY + h + 3, 0).color(red, green, blue, alpha).next();
					BUILDER.vertex(matrix, posX + f, posY + h + 3, 0).color(red, green, blue, alpha).next();
					BUILDER.vertex(matrix, posX + f, posY + h, 0).color(red, green, blue, alpha).next();
					BUILDER.vertex(matrix, posX, posY + h, 0).color(red, green, blue, alpha).next();
					TESSELLATOR.draw();
				...
				if(underline) {
					...
					BUILDER.begin(7, VertexFormats.POSITION_COLOR);
					BUILDER.vertex(matrix, posX, y1 + 4, 0).color(red, green, blue, alpha).next();
					BUILDER.vertex(matrix, posX + f, y1 + 4, 0).color(red, green, blue, alpha).next();
					BUILDER.vertex(matrix, posX + f, y1 + 2, 0).color(red, green, blue, alpha).next();
					BUILDER.vertex(matrix, posX, y1 + 2, 0).color(red, green, blue, alpha).next();
					TESSELLATOR.draw();
